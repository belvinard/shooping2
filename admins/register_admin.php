    ...
    <section class="form_container">
        <form action="" method="post" autocomplete="off">
            ...
            <div style="position: relative;">
                <input type="password" id="password" name="pass" required placeholder="enter your password" maxlength="20" class="box password-field" oninput="checkPasswordStrength(this.value)" autocomplete="off">
